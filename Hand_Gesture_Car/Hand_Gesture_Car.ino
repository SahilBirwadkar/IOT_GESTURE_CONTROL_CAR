...
void loop() {
  ...
  if(Ay < -0.5){
    delay(100);
    http.begin("http://192.168.1.107/forward");
    http.GET();
    http.end();
    ...
    delay(100);
    http.begin("http://192.168.1.107/backward");
    http.GET();
    http.end();
    digitalWrite(D1,LOW);
    ...
    delay(100);
    http.begin("http://192.168.1.107/left");
    http.GET();
    http.end();
    digitalWrite(D1,LOW);
    digitalWrite(D2,LOW);
    ...
    delay(100);
    http.begin("http://192.168.1.107/right");
    http.GET();
    http.end();
    digitalWrite(D1,LOW);
    digitalWrite(D2,LOW);
    ...
    delay(100);
    http.begin("http://192.168.1.107/halt");
    http.GET();
    http.end();
    digitalWrite(D1,LOW);
    digitalWrite(D2,LOW);
